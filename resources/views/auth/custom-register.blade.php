                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-control-user border-left-0 @error('nis') is-invalid @enderror"
                                            id="nis" name="nis" placeholder="NIS (Nomor Induk Siswa)" value="{{ old('nis') }}" required>
                                    </div>
                                    @error('nis')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group row">
                                    <div class="mb-3 col-sm-6 mb-sm-0">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control form-control-user border-left-0 @error('jurusan') is-invalid @enderror"
                                                id="jurusan" name="jurusan" placeholder="Jurusan" value="{{ old('jurusan') }}" required>
                                        </div>
                                        @error('jurusan')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control form-control-user border-left-0 @error('kelas') is-invalid @enderror"
                                                id="kelas" name="kelas" placeholder="Kelas" value="{{ old('kelas') }}" required>
                                        </div>
                                        @error('kelas')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
